...
| Patch Encoder        | Embedding dim | Link                                                                                                   | Args                                                      |
|----------------------|--------------:|--------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|
| **UNI**              |          1024 | [MahmoodLab/UNI](https://huggingface.co/MahmoodLab/UNI)                                                | `--patch_encoder uni_v1 --patch_size 256 --mag 20`        |
| **UNIv2**            |          1536 | [MahmoodLab/UNI2-h](https://huggingface.co/MahmoodLab/UNI2-h)                                          | `--patch_encoder uni_v2 --patch_size 256 --mag 20`        |
| **CONCH**            |           512 | [MahmoodLab/CONCH](https://huggingface.co/MahmoodLab/CONCH)                                            | `--patch_encoder conch_v1 --patch_size 512 --mag 20`      |
| **CONCHv1.5**        |           768 | [MahmoodLab/conchv1_5](https://huggingface.co/MahmoodLab/conchv1_5)                                    | `--patch_encoder conch_v15 --patch_size 512 --mag 20`     |
| **Virchow**          |          2560 | [paige-ai/Virchow](https://huggingface.co/paige-ai/Virchow)                                            | `--patch_encoder virchow --patch_size 224 --mag 20`       |
| **Virchow2**         |          2560 | [paige-ai/Virchow2](https://huggingface.co/paige-ai/Virchow2)                                          | `--patch_encoder virchow2 --patch_size 224 --mag 20`      |
| **Phikon**           |           768 | [owkin/phikon](https://huggingface.co/owkin/phikon)                                                    | `--patch_encoder phikon --patch_size 224 --mag 20`        |
| **Phikon-v2**        |          1024 | [owkin/phikon-v2](https://huggingface.co/owkin/phikon-v2/)                                             | `--patch_encoder phikon_v2 --patch_size 224 --mag 20`     |
| **Prov-Gigapath**    |          1536 | [prov-gigapath](https://huggingface.co/prov-gigapath/prov-gigapath)                                    | `--patch_encoder gigapath --patch_size 256 --mag 20`      |
| **H-Optimus-0**      |          1536 | [bioptimus/H-optimus-0](https://huggingface.co/bioptimus/H-optimus-0)                                  | `--patch_encoder hoptimus0 --patch_size 224 --mag 20`     |
| **H-Optimus-1**      |          1536 | [bioptimus/H-optimus-1](https://huggingface.co/bioptimus/H-optimus-1)                                  | `--patch_encoder hoptimus1 --patch_size 224 --mag 20`     |
| **MUSK**             |          1024 | [xiangjx/musk](https://huggingface.co/xiangjx/musk)                                                    | `--patch_encoder musk --patch_size 384 --mag 20`          |
| **Midnight-12k**     |          3072 | [kaiko-ai/midnight](https://huggingface.co/kaiko-ai/midnight)                                          | `--patch_encoder midnight12k --patch_size 224 --mag 20`   |
| **Kaiko**            | 384 (vits), 768 (vitb), 1024 (vitl) | Hosted on TorchHub                                                                                     | `--patch_encoder {kaiko-vits8, kaiko-vits16, kaiko-vitb8, kaiko-vitb16, kaiko-vitl14} --patch_size 256 --mag 20` |
| **Lunit**            |           384 | [1aurent/vit_small_patch8_224.lunit_dino](https://huggingface.co/1aurent/vit_small_patch8_224.lunit_dino) | `--patch_encoder lunit-vits8 --patch_size 224 --mag 20`   |
| **Hibou**            |          1024 | [histai/hibou-L](https://huggingface.co/histai/hibou-L)                                                | `--patch_encoder hibou_l --patch_size 224 --mag 20`       |
| **CTransPath-CHIEF** |           768 | Automatic download                                                                                     | `--patch_encoder ctranspath --patch_size 256 --mag 10`    |
| **ResNet50**         |          1024 | Hosted on torchvision                                                                                  | `--patch_encoder resnet50 --patch_size 256 --mag 20`      |
